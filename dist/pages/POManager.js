...
const OrderReviewPage_1 = require("./OrderReviewPage");
...
class POManager {
    constructor(page) {
        ...
        this.ordersHistoryPage = new OrderHistoryPage_1.OrdersHistoryPage(this.page);
        this.ordersReviewPage = new OrderReviewPage_1.OrdersReviewPage(this.page);
...
//# sourceMappingURL=POManager.js.map